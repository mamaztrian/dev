	...
	<footer id="footer" class="<?php extra_footer_classes(); ?>">
		...
		<div id="footer-bottom">
			<div class="container">
				...
				<!-- Footer Info -->
				<p id="footer-info"><?php printf( et_get_safe_localization( __( 'Pemerintah %1$s | Didesain Oleh %2$s', 'extra' ) ), '<a href="https://purbalinggakab.go.id/" target="_blank">Kabupaten Purbalingga</a>', '<a href="https://dinkominfo.purbalinggakab.go.id/" target="_blank">Dinas Komunikasi dan Informatika</a>' ); ?></p>
