...
class BarcodeGeneratorHTML extends BarcodeGenerator
{
     ...
     * @public
     */
    public function getBarcode($code, $type, $widthFactor = "", $totalHeight = "", $color = 'black')
    {
        $barcodeData = $this->getBarcodeData($code, $type);

        $html = '<div id="barcode" style="font-size:0;position:relative;width:' . ($barcodeData['maxWidth'] * $widthFactor) . 'px;height:' . ($totalHeight) . 'px;">' . "\n";
