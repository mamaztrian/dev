...
<link href="<?php echo Theme::base('assets/global/plugins/bootstrap-fileinput/bootstrap-fileinput.css') ?>" rel="stylesheet" type="text/css" />
...
@section('customjs')
<!-- BEGIN PAGE LEVEL PLUGINS -->
<script src="<?php echo Theme::base('assets/global/plugins/bootstrap-fileinput/bootstrap-fileinput.js') ?>" type="text/javascript"></script>
<script src="<?php echo Theme::base('assets/global/plugins/jquery.sparkline.min.js') ?>" type="text/javascript"></script>
