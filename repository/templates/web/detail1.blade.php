            ...
            <div class="detail__center tb-70 mb-100">
                ...
                <div>
                    <div class="detail__center__desc">
                        ...
                        <div class="detail__center__desc__field">{{ $result['tipe_dokumen'] ? $result['tipe_dokumen'] : '-' }}</div>
                    </div>
                    <div class="detail__center__desc">
                        <div class="detail__center__desc__title">Tahun Terbit</div>
                        <div class="detail__center__desc__field">{{ $result['tahun_terbit'] ? $schema['tahun_terbit']->format('plain', $result['tahun_terbit']) : '-' }}</div>
                    </div>
                    <div class="detail__center__desc">
                        <div class="detail__center__desc__title">Nomor Peraturan</div>
                        <div class="detail__center__desc__field">{{ $result['nomor_peraturan'] ? $result['nomor_peraturan'] : '-' }}</div>
                    </div>
                    <div class="detail__center__desc">
                        <div class="detail__center__desc__title">Bidang Hukum</div>
                        <div class="detail__center__desc__field">{{ $result['bidang_hukum'] ? $schema['bidang_hukum']->format('plain', $result['bidang_hukum']) : '-' }}</div>
                    </div>
                    <div class="detail__center__desc">
                        <div class="detail__center__desc__title">Tempat Penetapan</div>
                        <div class="detail__center__desc__field">{{ $result['tempat_terbit'] ? $result['tempat_terbit'] : '-' }}</div>
                    </div>
                    <div class="detail__center__desc">
                        <div class="detail__center__desc__title">Tanggal Penetapan / Pengundangan</div>
                        <div class="detail__center__desc__field">{{ is_null($result['tanggal_penetapan']) ? '-' : date('d M Y', strtotime($result['tanggal_penetapan'])) }}</div>
                    </div>
                    <div class="detail__center__desc">
                        <div class="detail__center__desc__title">Singkatan Jenis / Bentuk Peraturan</div>
                        <div class="detail__center__desc__field">{{ $result['singkatan_bentuk'] ? $result['singkatan_bentuk'] : '-' }}</div>
                    </div>
                    <div class="detail__center__desc">
                        <div class="detail__center__desc__title">Sumber</div>
                        <div class="detail__center__desc__field">{{ $result['sumber'] ? $result['sumber'] : '-' }}</div>
                    </div>
                    <div class="detail__center__desc">
                        <div class="detail__center__desc__title">Bahasa</div>
                        <div class="detail__center__desc__field">{{ !empty($result['bahasa']) ? $bahasa[$result['bahasa']] : '-' }}</div>
                    </div>
